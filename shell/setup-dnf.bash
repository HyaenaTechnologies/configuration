...
sudo dnf -y upgrade
# Install Utilities
sudo dnf -y install ssh dnf-utils dnf-plugins-core curl git zsh openssl openssl-devel ufw iptables firewalld nftables
# Install Tools
...
sudo dnf -y install ed sed nano kakoune podman
